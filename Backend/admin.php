    ...
    <div class="container">
        <div class="header-action">
            <div class="header-title-group">
                <a href="../Frontend/index.html" class="btn-home" title="Kembali ke Halaman Pelanggan">
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            echo "<tr>";
                            echo "<td style='color: #888; font-weight: 500;'>" . $row['id'] . "</td>";
                            
                            echo "<td><div class='img-wrapper'><img src='" . htmlspecialchars($row['image']) . "' alt='gambar'></div></td>";
                            
                            echo "<td><div class='product-name'>" . htmlspecialchars($row['name']) . "</div></td>";
                            echo "<td><span class='badge-cat'>" . htmlspecialchars($row['category']) . "</span></td>";
                            echo "<td class='price'>Rp " . number_format($row['price'], 0, ',', '.') . "</td>";
                            echo "<td class='stock'>" . $row['stock'] . "</td>";
                            
                            echo "<td>
                                    <div class='action-group' style='justify-content: center;'>
                                        <a href='edit.php?id=" . $row['id'] . "' class='btn btn-edit'>Edit</a>
                                        <a href='proses_hapus.php?id=" . $row['id'] . "' class='btn btn-hapus' onclick='return confirm(\"Yakin ingin menghapus " . htmlspecialchars($row['name']) . "?\")'>Hapus</a>
                                    </div>
                                  </td>";
                            echo "</tr>";
                        }
